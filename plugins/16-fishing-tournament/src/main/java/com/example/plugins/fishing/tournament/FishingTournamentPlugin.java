package com.example.plugins.fishing.tournament;
...
public final class FishingTournamentPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("fish");
        getLogger().info("FishingTournamentPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("FishingTournamentPlugin disabled.");
    }
