package com.example.plugins.mini.event.scheduler;
...
public final class MiniEventSchedulerPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("events");
        getLogger().info("MiniEventSchedulerPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("MiniEventSchedulerPlugin disabled.");
    }
