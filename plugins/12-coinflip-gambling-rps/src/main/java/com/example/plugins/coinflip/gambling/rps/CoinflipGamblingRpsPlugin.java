package com.example.plugins.coinflip.gambling.rps;
...
public final class CoinflipGamblingRpsPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("coinflip");
        registerCommand("rps");
        getLogger().info("CoinflipGamblingRpsPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("CoinflipGamblingRpsPlugin disabled.");
    }
