package com.example.plugins.envoy;
...
public final class EnvoyPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("envoy");
        getLogger().info("EnvoyPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("EnvoyPlugin disabled.");
    }
