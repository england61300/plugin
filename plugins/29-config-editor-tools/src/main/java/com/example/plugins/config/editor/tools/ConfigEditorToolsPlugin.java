package com.example.plugins.config.editor.tools;
...
public final class ConfigEditorToolsPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("editor");
        getLogger().info("ConfigEditorToolsPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("ConfigEditorToolsPlugin disabled.");
    }
