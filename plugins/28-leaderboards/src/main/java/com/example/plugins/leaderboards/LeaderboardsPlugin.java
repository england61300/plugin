package com.example.plugins.leaderboards;
...
public final class LeaderboardsPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("top");
        getLogger().info("LeaderboardsPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("LeaderboardsPlugin disabled.");
    }
