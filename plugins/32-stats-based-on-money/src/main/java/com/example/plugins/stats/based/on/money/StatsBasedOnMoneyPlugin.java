package com.example.plugins.stats.based.on.money;
...
public final class StatsBasedOnMoneyPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("moneybonus");
        getLogger().info("StatsBasedOnMoneyPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("StatsBasedOnMoneyPlugin disabled.");
    }
