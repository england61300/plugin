package com.example.plugins.logging.audit;
...
public final class LoggingAuditPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("audit");
        getLogger().info("LoggingAuditPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("LoggingAuditPlugin disabled.");
    }
