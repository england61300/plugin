package com.example.plugins.advanced.currency.tokens;
...
public final class AdvancedCurrencyTokensPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("tokens");
        getLogger().info("AdvancedCurrencyTokensPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("AdvancedCurrencyTokensPlugin disabled.");
    }
