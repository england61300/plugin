package com.example.plugins.player.trading;
...
public final class PlayerTradingPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("trade");
        getLogger().info("PlayerTradingPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("PlayerTradingPlugin disabled.");
    }
