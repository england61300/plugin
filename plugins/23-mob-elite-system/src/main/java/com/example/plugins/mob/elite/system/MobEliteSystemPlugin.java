package com.example.plugins.mob.elite.system;
...
public final class MobEliteSystemPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("elite");
        getLogger().info("MobEliteSystemPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("MobEliteSystemPlugin disabled.");
    }
