package com.example.plugins.koth.area.control;
...
public final class KothAreaControlPlugin extends JavaPlugin {
    @Override
    public void onEnable() {
        registerCommand("koth");
        getLogger().info("KothAreaControlPlugin enabled.");
    }

    @Override
    public void onDisable() {
        getLogger().info("KothAreaControlPlugin disabled.");
    }
